...
and inform you about voucher codes and much more. Your ZIZLE support team.`;
            await this.mailService.sendWelcomeMail(savedUser === null || savedUser === void 0 ? void 0 : savedUser.email, {
                authLoginLink: frontendUrlClient,
                firstName: savedUser === null || savedUser === void 0 ? void 0 : savedUser.firstName,
                productName,
                message,
            });
        ...
        if (!user || (user.role === types_1.UserRoleEnum.CUSTOMER && user.status === types_1.UserStatusEnum.DEACTIVATE)) {
            throw new common_1.HttpException('No user found', common_1.HttpStatus.NOT_FOUND);
        }
        if (user.role === types_1.UserRoleEnum.CUSTOMER && user.status === types_1.UserStatusEnum.INACTIVE) {
            throw new common_1.HttpException('User needs approval!', common_1.HttpStatus.NOT_FOUND);
        }
