...
CoinsModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([user_entity_1.User, user_transaction_actiontypes_entity_1.UserTransactionActionTypes, email_entity_1.Email]), auth_module_1.AuthModule, user_module_1.UserModule],
        controllers: [coins_controller_1.CoinsController],
        providers: [coins_service_1.CoinsService, mail_service_1.MailService, cloudinary_config_1.CloudinaryConfigService],
    })
], CoinsModule);
