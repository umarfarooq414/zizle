...
import {
  resigterFakeUserAction,resigterSubsUserAction
} from './actions';
...
export const userFakeSlice = createSlice({
  ...
  extraReducers: {
    ...
    [resigterSubsUserAction.pending]: (state) => {
      state.isLoading = true;
    },
    [resigterSubsUserAction.fulfilled]: (state, { payload }) => {
      state.isLoading = false;
      state.errorMessage = null;
      state.successMessage = payload;
      state.accessToken = payload.access_token;
    },
    [resigterSubsUserAction.rejected]: (state, { payload }) => {
      state.isLoading = false;
      state.errorMessage = payload;
    },
